...
public class BestFirstSearch {
    ...
    public void searchRoute(DataFromTextFile data, MyCustomer<Integer, Integer> cus, Vehicle car) {

        int numberOfCustomers = data.getNumOfCustomer() - 1;
        numberOfCustomers = cus.getSize() - 1;
        int vehicleMaxCapacity = data.getCapacity();
